...
| [GZTime 博客](https://blog.gztime.cc/posts/2022/a689d378/) [备用](https://blog.gzti.me/posts/2022/a689d378/) | 总排名第 7 名 | **除** 置换魔群(3)、矩阵之困、链上记忆大师(2,3)、片上系统(2)、壹...壹字节？、企鹅拼盘(3)、小 Z 的靓号钱包、火眼金睛的小 E(2,3) **外的全部题目** |
...
| [xtex](https://blog.xtexx.ml/2022/10/28/ustc-hackergame2022/) | 总排名第 185 名 | 签到, 猫咪问答喵1，家目录里的秘密， HeiLang, Xcaptcha, 旅行照片 2.0-1，Latex机器人-1, Flag 的痕迹，线路板， Flag 自动机，微积分计算小练习，杯窗鹅影， 光与影 |
...
| [LetianYuan](players/LetianYuan/writeup.pdf) | 总排名第54名 | Flag的痕迹（rev解）、LaTeX机器人（catcode解）、看不见的彼方（消息队列解）三个非官方预期解以及一些其他题目 |
...
| [zqm](players/zqm/README.md) | 总排名第 90 名 | 签到、猫咪问答喵、家目录里的秘密、HeiLang、Xcaptcha、旅行照片 2.0、猜数字、LaTeX 机器人、Flag 的痕迹、 安全的在线测评-1、 线路板、 Flag 自动机、 微积分计算小练习、 杯窗鹅影-1、 蒙特卡罗轮盘赌、 光与影、 片上系统-1、 量子藏宝图、 企鹅拼盘(1/2)、 火眼金睛的小 E-1|
| [txtxj](https://txtxj.top/posts/hackergame2022/) | 总排名第 79 名 | 签到、猫咪问答喵、家目录里的秘密、HeiLang、Xcaptcha、旅行照片 2.0-1、猜数字、LaTeX 机器人、Flag 的痕迹、安全的在线测评、线路板、Flag 自动机、微积分计算小练习、杯窗鹅影、蒙特卡罗轮盘赌、置换魔群-1、光与影、量子藏宝图、企鹅拼盘-1、火眼金睛的小 E-1 |
| [Ciel](players/Ciel/README.md) | 总排名第 59 名 | 签到、猫咪问答喵、家目录里的秘密、HeiLang、Xcaptcha、旅行照片 2.0、猜数字、LaTeX 机器人、Flag 的痕迹、安全的在线测评、线路板、微积分计算小练习、杯窗鹅影、蒙特卡罗轮盘赌、惜字如金 HS384、光与影、传达不到的文件、量子藏宝图、企鹅拼盘1-2 |
...
| [USHIO](players/USHIO/README.md) | 总排名第 91 名 | 签到、猫咪问答喵、家目录里的秘密、HeiLang、Xcaptcha、旅行照片 2.0、猜数字、LaTeX 机器人、Flag 的痕迹、安全的在线测评-无法 AC 的题目、线路板、Flag 自动机、微积分计算小练习、杯窗鹅影-flag1、蒙特卡罗轮盘赌、惜字如金-HS384、置换魔群-置换群上的RSA、光与影、片上系统-引导扇区、企鹅拼盘-这么简单我闭眼都可以！、火眼金睛的小 E-有手就行 |
| [Hanako](https://hanako.me/hg2022.html) | 总排名第 47 名 | 签到、猫咪问答喵、家目录里的秘密、HeiLang、Xcaptcha、旅行照片 2.0、猜数字、LaTeX 机器人、Flag 的痕迹、安全的在线测评-无法 AC 的题目、线路板、Flag 自动机、微积分计算小练习、杯窗鹅影、蒙特卡罗轮盘赌、惜字如金-HS384、光与影、片上系统-引导扇区、传达不到的文件、量子藏宝图、企鹅拼盘-这么简单我闭眼都可以！/大力当然出奇迹啦~、火眼金睛的小 E-有手就行/唯快不破 |
...
[Hackergame 2022 幕后工作人员](./credits.pdf)
